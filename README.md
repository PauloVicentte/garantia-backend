...
🎯 Objetivo
Automatizar o fluxo de garantia: do envio da solicitação pelo cliente até a análise técnica e decisão final.

🛠 Tecnologias
.NET (C#) – endpoints REST
Camunda BPMN – processos de negócio
DMN – regras de decisão (análise técnica)
